...
uniTerm supports establishing SSH-family connections through SOCKS5 / HTTP proxies, and AI model requests can also go through a proxy. Proxies are managed centrally in **Settings → Proxy**.
