...
uniTerm automatically records commands entered in the terminal, deduplicates them, and stores them locally. History lives in the same panel as quick commands; switch to it with the "History" tab.
