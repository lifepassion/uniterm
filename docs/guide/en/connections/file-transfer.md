...
uniTerm has a built-in dual-pane file browser that supports multiple file transfer protocols, providing a unified file management interface. Files on SSH connections can also be managed through the [Files sidebar](/en/features/sidebar).
